...
#applying the variables like time, hr, min, sec etc
def date_time():
...
clock = Tk()
#apply graphics in between them
...
lab_year_txt= Label(clock,text="Sec",font=('Time New Roman', 20,"bold"),bg='red', fg="white")
...
lab_day_txt.place(x=560,y=410,height=40,width=100)

#execute the program of the clock
date_time()
